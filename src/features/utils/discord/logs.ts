import { GuildMember, GuildMemberRoleManager, MessageEmbed, PartialGuildMember, PermissionResolvable, TextChannel, VoiceState } from "discord.js";
...
export default class MemberJoin extends Util {
    ...
    private onJoin(member: GuildMember){
        ...
        (My.celena.channels.resolve(My.config.celena.log.channels.discord_gate) as TextChannel).send({embeds: [embed]});
